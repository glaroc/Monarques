...
where=paste0('grts_id=191585 OR (suitable>50000 AND rand<=',randval,')')
...
execGRASS('v.out.ogr',input='selected_blocks', type='area',output='/home/ubuntu/data/Monarques/selected_blocks_2023.gpkg', flags=c('overwrite'))
...
execGRASS('v.out.ogr', input='all30', type='point', output='/home/ubuntu/data/Monarques/all30_2023.gpkg',flags=c('overwrite'))
...
```{r, eval=TRUE}
execGRASS('v.in.ogr',input='/home/ubuntu/data/Monarques/Monarques-repo/data/all30_2023_with_all_cats.gpkg', output= 'all30_with_cats', flags=c('overwrite','o'))
...
write.csv(all30,'/home/ubuntu/data/Monarques/Monarques-repo/data/all30_2023_with_ids.csv')
```
